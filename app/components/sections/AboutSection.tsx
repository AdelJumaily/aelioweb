  ...
  return (
    ...
    >
      <div className="sticky top-0 h-screen overflow-hidden">
        <div className="absolute left-6 md:left-12 lg:left-20 top-1/2 -translate-y-1/2 z-10">
        ...
        <div
          ref={cardsRef}
          className="absolute top-0 left-0 h-screen flex items-center pl-[350px] md:pl-[450px] lg:pl-[550px]"
          style={{ willChange: "transform" }}
        >
          {aboutCards.map((card, index) => (
            <div
              key={card.id}
              className={`h-[80vh] w-[85vw] md:w-[70vw] lg:w-[60vw] flex-shrink-0 bg-gradient-to-br ${card.gradient} rounded-3xl p-8 md:p-12 lg:p-16 flex flex-col justify-center ${index < aboutCards.length - 1 ? 'mr-2 md:mr-3 lg:mr-4' : ''}`}
            >
