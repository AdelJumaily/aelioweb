...
export default function Footer() {
  return (
    <footer className="bg-[#f5f1e8] border-t border-black/10 py-16 px-6 md:px-12 lg:px-20">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          {/* Company Info */}
          <div>
            <h3 className="text-2xl font-bold text-black mb-4">Aelio</h3>
            <p className="text-black/70 mb-4">
              We create digital experiences that drive results. From websites to mobile apps, we bring your vision to life.
            </p>
          </div>
